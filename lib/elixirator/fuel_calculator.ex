defmodule Elixirator.FuelCalculator do
  @moduledoc """
  FuelCalculator calculates fuel required for a mission
  """

  @land_constant_a 0.033
  @land_constant_b 42
  @launch_constant_a 0.042
  @launch_constant_b 33
  ...
  def calculate_total_fuel( _mass, []) do {:error, :invalid_route_params} end
  ...
  def calculate_fuel_for_step(calculated_fuel, mass, {:land, gravity}) do
    fuel = (mass * gravity * @land_constant_a) - @land_constant_b |> floor()
  ...
  def calculate_fuel_for_step(calculated_fuel, mass, {:launch, gravity}) do
    fuel = (mass * gravity * @launch_constant_a) - @launch_constant_b |> floor
    sum_fuel(calculated_fuel, fuel)
    |> calculate_fuel_for_step(fuel, {:launch, gravity})
  end

  def calculate_fuel_for_step(_, _, _) do {:error,:invalid_route_params} end
end
